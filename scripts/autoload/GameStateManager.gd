...
## Nothing outside this file should call __set_state() directly.
extends Node2D
...
#Transition Requests
signal transition_requested(type: TransitionManager.Type)
...
func request_respawn() -> void:
	## TODO: Redundant wrapper function? Look over respawn logic for clarification.
...
func _on_level_loaded() -> void:
	transition_requested.emit(TransitionManager.Type.CIRCLE_FROM_BLACK)
	_set_state(GameState.GAMEPLAY)
